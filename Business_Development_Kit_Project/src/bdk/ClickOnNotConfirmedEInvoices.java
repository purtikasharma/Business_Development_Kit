...
public class ClickOnNotConfirmedEInvoices {
	ChromeDriver driver;
	@Before
	...
	@Test
	public void NotConfirmed() throws InterruptedException
	{
		driver.get(URL.url);
		...
		Thread.sleep(50000);
		WebElement NotConfirmedE = driver.findElement(By.className("notconfirmed"));
		NotConfirmedE.click();		
	}
	@After
	public void Close()
